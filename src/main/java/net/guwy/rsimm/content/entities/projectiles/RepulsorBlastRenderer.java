...
public class RepulsorBlastRenderer extends EntityRenderer<RepulsorBlastEntity> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(RsImm.MOD_ID, "textures/entity/repulsor_blast.png");
    public static final ResourceLocation TEXTURE_TRANSPARENT = new ResourceLocation(RsImm.MOD_ID, "textures/entity/repulsor_blast_extra_transparent.png");
    private static final float MAX_LIFETIME = 60;

    public RepulsorBlastRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    @Override
    public ResourceLocation getTextureLocation(RepulsorBlastEntity pEntity) {
        return TEXTURE_TRANSPARENT;
    }

    @Override
    public void render(RepulsorBlastEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
        ...
        VertexConsumer vertexconsumer = pBuffer.getBuffer(RenderType.entityTranslucentCull(this.getTextureLocation(pEntity)));
