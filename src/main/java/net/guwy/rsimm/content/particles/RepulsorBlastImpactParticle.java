...
public class RepulsorBlastImpactParticle extends SimpleAnimatedParticle {

    private final SpriteSet spriteSet;
    private int loopLength;

    private int DISPLAY_TIME = 1;

    public RepulsorBlastImpactParticle(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet spriteSet, double pXSpeed, double pYSpeed, double pZSpeed) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level,
            ...
            return new RepulsorBlastImpactParticle(level, x, y, z, this.sprites, dx, dy, dz);
        }
    }
}
