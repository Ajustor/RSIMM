...
public class ArmorEquippingStationMenu extends AbstractContainerMenu {

    public final ArmorEquippingStationBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public ArmorEquippingStationMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public ArmorEquippingStationMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            ...
            this.addSlot(new SlotItemHandler(handler, 1, 80,28));
            this.addSlot(new SlotItemHandler(handler, 2, 80,46));
            this.addSlot(new SlotItemHandler(handler, 3, 80,64));
            this.addSlot(new SlotItemHandler(handler, 4, 104,46));
        });
