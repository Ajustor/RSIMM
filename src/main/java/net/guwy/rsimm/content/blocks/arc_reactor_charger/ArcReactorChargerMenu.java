...
public class ArcReactorChargerMenu extends AbstractContainerMenu {
    public final ArcReactorChargerBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public ArcReactorChargerMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
