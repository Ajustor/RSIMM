package net.guwy.rsimm.content.recipe;
...
public class ArcReactorChargerRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Type implements RecipeType<ArcReactorChargerRecipe> {
        private Type() { }
    ...
    public static class Serializer implements RecipeSerializer<ArcReactorChargerRecipe> {
        ...
        @Override
        public ArcReactorChargerRecipe fromJson(ResourceLocation pRecipeId, JsonObject pSerializedRecipe) {
